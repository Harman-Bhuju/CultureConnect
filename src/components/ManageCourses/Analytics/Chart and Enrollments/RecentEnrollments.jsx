...
import { Filter, ChevronDown, Clock, BookOpen, Users } from "lucide-react";
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-4">
          ...
          <div className="relative self-start sm:self-auto">
            <select
              ...
              className="appearance-none pl-3 sm:pl-4 pr-8 sm:pr-10 py-2 bg-gray-50 border border-gray-200 rounded-lg text-xs sm:text-sm font-medium text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-orange-500 cursor-pointer transition-colors">
          ...
          Object.entries(groupedEnrollments).map(([date, items]) => (
            <div key={date}>
              ...
              <div className="flex items-center mb-2 sm:mb-3">
                <div className="text-xs sm:text-sm font-semibold text-gray-900 bg-orange-50 border border-orange-200 px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-full">
                  {date}
                </div>
