...
const TransactionHistory = ({ selectedPeriod }) => {
  const { completedOrders: allCompletedOrders, loading } =
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <div className="relative">
              <select
                ...
                className="w-full appearance-none pl-4 pr-10 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-green-500 cursor-pointer transition-colors">
                      ...
                      <div className="flex-1">
                        <div className="flex flex-col sm:flex-row items-start gap-4">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mt-4 pt-4 border-t border-gray-100">
                              <div>
                                <p className="text-xs text-gray-500 font-medium">
                                  Unit Price
                                </p>
                            ...
                            <div className="flex flex-wrap items-center gap-3 mt-4 pt-3 border-t border-gray-100">
                              ...
                              <div className="flex items-center gap-3 ml-auto sm:ml-0 text-xs text-gray-500">
                                ...
                                <span>Ordered at {order.orderDate}</span>
                              </div>
                            </div>
                          </div>
                        </div>
