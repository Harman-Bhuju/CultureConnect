        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
          ...
          <div className="flex items-center justify-between mb-4 flex-wrap gap-4">
            <div className="flex items-center gap-2 sm:gap-3">
              <button
                onClick={() => navigate(-1)}
                className="flex items-center gap-2 px-2.5 py-1.5 sm:px-3 sm:py-2 text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-none w-full sm:w-auto -mx-4 px-4 sm:mx-0 sm:px-0">
              <button
                onClick={() => setActiveTab("cart")}
                className={`px-4 py-2 sm:py-2.5 rounded-lg text-xs sm:text-sm font-medium transition-all flex items-center gap-2 whitespace-nowrap ${
                  activeTab === "cart"
