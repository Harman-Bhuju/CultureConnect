  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {reports.length === 0 ? (
        <div className="bg-white rounded-2xl p-12 text-center border border-dashed border-slate-300">
          ...
          <p className="text-slate-400">
            Great job! No delivery boy mistakes or customer disputes recorded
            yet.
          </p>
        </div>
      ) : (
                ...
                {reports.map((report) => (
                  <tr
                    ...
                    <td className="px-6 py-4 text-right">
                      <button
                        onClick={() =>
                          initiateResolve(report.order_id, report.order_no)
                        }
            ...
            {reports.map((report) => (
              <div
                ...
                <div className="grid grid-cols-2 gap-3 text-xs">
                  <div>
                    ...
                    <div className="flex items-center gap-1.5 mt-0.5">
                      <div className="w-5 h-5 rounded-full bg-white border border-slate-200 flex items-center justify-center text-[8px] font-bold text-slate-500 uppercase">
                        {report.customer.charAt(0)}
                      </div>
                ...
                <button
                  ...
                  className="w-full py-2.5 bg-slate-800 text-white text-xs font-bold uppercase rounded-lg hover:bg-slate-900 transition-all flex items-center justify-center gap-2 mt-2">
      ...
      <div className="p-4 bg-red-50 rounded-xl border border-red-100 flex gap-3">
        ...
        <div>
          <p className="text-sm font-bold text-red-800 lowercase first-letter:uppercase">
            Important notice
          </p>
          <p className="text-xs text-red-700 mt-0.5">
            Please review these reports carefully. Frequent discrepancies may
            result in account review. Contact support if you believe a report is
            incorrect.
          </p>
        </div>
      </div>
